use http::{httprequest::HttpRequest, httpresponse::HttpResonse};
...
pub trait Handler {
    fn handle(req: &HttpRequest) -> HttpResonse;
...
impl Handler for PageNotFoundHander {
    fn handle(req: &HttpRequest) -> HttpResonse {
        ...
        match route[1] {
            ...
            path => match Self::load_file(path) {
                Some(contents) => {
                    ...
                    HttpResonse::new("200", Some(map), Some(contents))
                }
